...
* "slack_threshold_grow": the SLO slack above which we grow BE pods (0.15)
* "load_threshold_shrink": the CPU load threshold after which we shrink BE pods (90.0)
* "load_threshold_grow": the CPU load threshold to which we allow BE pods to grow (75.0)
